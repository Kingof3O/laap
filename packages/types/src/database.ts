...
export interface Database {
  public: {
    Tables: {
      ...
      accounts: { Row: { id: string; provider: string; external_id: string; display_name: string; region: string; status: 'available' | 'maintenance' | 'disabled'; vault_secret_id: string | null; metadata: Record<string, unknown>; session_blob: string | null; created_at: string; updated_at: string }; Insert: Omit<Database['public']['Tables']['accounts']['Row'], 'id' | 'created_at' | 'updated_at'> & { id?: string; created_at?: string; updated_at?: string }; Update: Partial<Database['public']['Tables']['accounts']['Insert']> }
      user_roles: { Row: { user_id: string; role: 'admin' | 'operator'; created_at: string; updated_at: string }; Insert: Omit<Database['public']['Tables']['user_roles']['Row'], 'created_at' | 'updated_at'> & { created_at?: string; updated_at?: string }; Update: Partial<Database['public']['Tables']['user_roles']['Insert']> }
